...
const ConteoCreate = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f7f8fa] p-0 sm:p-6">
            <div className="max-w-full sm:max-w-4xl mx-auto">
                {/* Card de Header */}
                <div className="bg-white rounded-xl shadow-lg mb-4 sm:mb-6 p-4">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-2">
                        ...
                        <div className="flex gap-2 w-full sm:w-auto">
                            <button
                                ...
                                className="bg-[#fff5f7] hover:bg-[#fce7eb] text-[#f58ea3] font-bold py-2 px-4 rounded-lg flex items-center justify-center text-sm sm:text-base border border-[#f58ea3] transition-colors shadow-sm w-full sm:w-auto"
                            >
                                <FaTimes className="mr-2" /> Cancelar
                            </button>
                            <button
                                onClick={handleConfirmar}
                                className="bg-[#f58ea3] hover:bg-[#f7b3c2] text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center text-sm sm:text-base transition-colors shadow-sm w-full sm:w-auto"
                            >
                    ...
                    <div className="grid grid-cols-1 gap-3 sm:gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className="mt-1 block w-full p-2 border rounded-lg text-sm focus:ring-2 focus:ring-[#f58ea3] focus:border-[#f58ea3] transition-colors"
                            />
                        </div>
                        <div>
                            ...
                            <input
                                ...
                                value={conteoId || ''}
                                disabled
                                className="mt-1 block w-full p-2 border rounded-lg text-sm bg-gray-50"
                            />
                        </div>
                        <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                        <div>
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    ...
                                    className="mt-1 p-2 border rounded-lg bg-[#fff5f7] hover:bg-[#fce7eb] text-[#f58ea3] transition-colors shadow-sm"
                                >
                        ...
                        <div className="flex items-end">
                            <button
                                ...
                                disabled={isLoading}
                                className="w-full bg-[#f58ea3] hover:bg-[#f7b3c2] text-white font-bold py-2 px-4 rounded-lg flex items-center justify-center text-sm sm:text-base transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                                {isLoading ? (
                    ...
                    <div className="mb-4">
                        <div className="relative">
                            <input
                                ...
                                className="w-full p-2 pl-10 border rounded-lg text-sm focus:ring-2 focus:ring-[#f58ea3] focus:border-[#f58ea3] transition-colors"
                            />
                            ...
                            {isSearching && searchPageNumber === 1 ? (
                                ...
                                <>
                                    {detalles.map((detalle) => (
                                        <div key={detalle.art_sec} className="border rounded-xl p-3 bg-gray-50">
                                                    ...
                                                    {editingCantidad === detalle.art_cod ? (
                                                        <div className="flex items-center gap-2">
                                                            <input
                                                                ...
                                                                className="w-20 p-1 border rounded-lg text-sm focus:ring-2 focus:ring-[#f58ea3] focus:border-[#f58ea3] transition-colors"
                                                                min="0"
                                                            />
                                    ...
                                    {hasMoreSearch && !isSearching && (
                                        <div className="text-center">
                                            <button
                                                ...
                                                className="bg-[#fff5f7] hover:bg-[#fce7eb] text-[#f58ea3] font-bold py-2 px-4 rounded-lg text-sm border border-[#f58ea3] transition-colors shadow-sm"
                                            >
