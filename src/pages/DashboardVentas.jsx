...
const DashboardVentas = () => {
  ...
  const calculateTotals = (invoices) => {
    ...
    return {
      ...
      wooCommission: wooSales * 0.05,
      localCommission: localSales * 0.025,
      wooInvoicesCount: wooInvoices.length,
      localInvoicesCount: localInvoices.length,
      totalInvoicesCount: invoices.length,
      get totalCommission() {
        return this.wooCommission + this.localCommission;
      }
    };
  };
  ...
  const chartData = salesData ? {
    labels: salesData.daily_sales.map(sale => formatDate(sale.fac_fec)),
    datasets: [{
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-purple-100 rounded-lg shadow p-6">
                ...
                <div className="text-sm text-purple-700 mt-2 space-y-1">
                  ...
                  <p>Total Facturas: {totals.wooInvoicesCount}</p>
                </div>
              </div>
              ...
              <div className="bg-green-100 rounded-lg shadow p-6">
                ...
                <div className="text-sm text-green-700 mt-2 space-y-1">
                  ...
                  <p>Total Facturas: {totals.localInvoicesCount}</p>
                </div>
              </div>
              ...
              <div className="bg-blue-100 rounded-lg shadow p-6">
                ...
                <div className="text-sm text-blue-700 mt-2 space-y-1">
                  ...
                  <p>Total Facturas: {totals.totalInvoicesCount}</p>
                </div>
              </div>
            </div>
